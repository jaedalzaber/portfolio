...
let i_ui_1 = process.env.PUBLIC_URL + '/assets/img/anim_ui_1_thumb.png';
let i_ui_2 = process.env.PUBLIC_URL + '/assets/img/anim_ui_2_thumb.png';
let i_ui_3 = process.env.PUBLIC_URL + '/assets/img/anim_ui_3_thumb.png';
let i_2d_1 = process.env.PUBLIC_URL + '/assets/img/anim_2d_1_thumb.png';
let i_2d_2 = process.env.PUBLIC_URL + '/assets/img/anim_2d_2_thumb.png';
let i_2d_3 = process.env.PUBLIC_URL + '/assets/img/anim_2d_3_thumb.png';
let i_3d_1 = process.env.PUBLIC_URL + '/assets/img/anim_3d_1_thumb.png';
let i_3d_2 = process.env.PUBLIC_URL + '/assets/img/anim_3d_2_thumb.png';
let i_3d_3 = process.env.PUBLIC_URL + '/assets/img/anim_3d_3_thumb.png';
let i_3d_4 = process.env.PUBLIC_URL + '/assets/img/anim_3d_4_thumb.png';
// import { Link, useNavigate , useLocation  } from 'react-router-dom';

const Motion = React.forwardRef((props, ref) => {
	...
	return (
		<div className={styles['grid']} data-scroll-section>
			...
			<div className={`${styles['grid--item']} ${styles['grid--item-5']}`} >
				<div className={styles['motion--header']}>
					<div className={styles.title}>
						<span className={styles.title__bold}>motion</span><br />
						<span className={styles.title__light}>Design</span>
					</div>
					<div className={styles['header-icon']}>
						...
						<svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path fillRule="evenodd" clipRule="evenodd" d="M25.7917 2.54698H2.26134V26.0773H25.7917V2.54698ZM0.378906 0.664551V27.9598H27.6741V0.664551H0.378906Z" fill="#CDD0DF" />
							<path d="M14.2148 17.486H10.0283L9.33556 19.4889H7.12183L10.9017 8.9624H13.3564L17.1364 19.4889H14.9076L14.2148 17.486ZM13.6426 15.7994L12.1216 11.402L10.6006 15.7994H13.6426Z" fill="#CDD0DF" />
							<rect x="18.8159" y="12.9204" width="2.11167" height="6.72162" fill="#CDD0DF" />
							<rect x="18.8159" y="9.62598" width="2.11167" height="2.04442" fill="#CDD0DF" />
						</svg>
			...
			<div className={`${styles['grid--item']} ${styles['grid--item-6']} ${styles['mg-lt-50']}`} >
				<span className={styles['motion-title']}>UI Animation</span>
			</div>

			<Link to={`/portfolio/uianimation`} className={`${styles['grid--item']} ${styles['grid--item-7']}`} >
				<div className={`${styles['gallery']} ${styles['mg-t-50']}`}>
					<div className={`${styles['item']} ${styles['item-1']}`} style={{ backgroundImage: `url(${i_ui_1})` }}></div>
					<div className={`${styles['item']} ${styles['item-2']}`} style={{ backgroundImage: `url(${i_ui_2})` }}></div>
					<div className={`${styles['item']} ${styles['item-3']}`} style={{ backgroundImage: `url(${i_ui_3})` }}></div>
				</div>
				<div className={styles['more-btn']}><SeeMoreBtn /></div>
			</Link>

			<div className={`${styles['grid--item']} ${styles['grid--item-8']} ${styles['mg-lt-50']}`} >
				<span className={styles['motion-title']}>2D Animation</span>
			</div>
			<Link to={`/portfolio/2danimation`} className={`${styles['grid--item']} ${styles['grid--item-9']}`} >
				<div className={`${styles['gallery']} ${styles['mg-t-50']}`}>
					<div className={`${styles['item']} ${styles['item-1']}`} style={{ backgroundImage: `url(${i_2d_1})` }}></div>
					<div className={`${styles['item']} ${styles['item-2']}`} style={{ backgroundImage: `url(${i_2d_2})` }}></div>
					<div className={`${styles['item']} ${styles['item-3']}`} style={{ backgroundImage: `url(${i_2d_3})` }}></div>
				</div>
				<div className={styles['more-btn']} ><SeeMoreBtn /></div>
			</Link>

			<div className={`${styles['grid--item']} ${styles['grid--item-10']} ${styles['mg-lt-50']}`} >
				<span className={styles['motion-title']}>3D Animation</span>
			</div>
			<Link to={`/portfolio/3danimation`} className={`${styles['grid--item']} ${styles['grid--item-11']}`} >
				<div className={`${styles['gallery']} ${styles['mg-t-50']}`}>
					<div className={`${styles['item']} ${styles['item-1']}`} style={{ backgroundImage: `url(${i_3d_1})` }}></div>
					<div className={`${styles['item']} ${styles['item-2']}`} style={{ backgroundImage: `url(${i_3d_2})` }}></div>
					<div className={`${styles['item']} ${styles['item-3']}`} style={{ backgroundImage: `url(${i_3d_3})` }}></div>
					<div className={`${styles['item']} ${styles['item-4']}`} style={{ backgroundImage: `url(${i_3d_4})` }}></div>
				</div>
				<div className={styles['more-btn']} ><SeeMoreBtn /></div>
			</Link>
			<div className={`${styles['grid--item']} ${styles['grid--item-12']}`}></div>
		</div>
	);
})
